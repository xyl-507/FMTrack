...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='bat', choices=['bat'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='rgbt', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "bat":
        ...
        model_constructor = model_module.build_batrack
