...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='tbsi_track', choices=['tbsi_track'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='vitb_256_tbsi_32x1_1e4_lasher_15ep_sot', help='yaml configure file name')
