...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='vipt', choices=['vipt'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='deep_rgbt', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "vipt":
        ...
        model_constructor = model_module.build_viptrack
        ...
        template_list = template.repeat(1,2,1,1)
        search_list = search.repeat(1,2,1,1)
